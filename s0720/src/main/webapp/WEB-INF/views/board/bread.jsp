  ...
  <section>
    ...
    <table>
     <colgroup>
      ...
      <tr><td  colspan="3" ><strong>다음글</strong> <span class="separator">|</span> <a href="bread?bno=${next.bno}&page=${page}&category=${category}&s_word=${s_word}">${next.btitle}</a></td> </tr>
      <tr><td  colspan="3" ><strong>이전글</strong> <span class="separator">|</span> <a href="bread?bno=${prev.bno}&page=${page}&category=${category}&s_word=${s_word}">${prev.btitle}</a></td> </tr>
    </table>
