		...
		error : function(){
			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
						<form method="post" name="loginFrm" action="loginB">
							<ul>
								<li>
								...
								<li>
								<input type="text" name="pw" id="pw" class="passType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" />
								</li>
							</ul>
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<li><input type="text" name="id" id="id" class="ordererType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='ordererType'}else {this.className='mfocusnot'}" /></li>
