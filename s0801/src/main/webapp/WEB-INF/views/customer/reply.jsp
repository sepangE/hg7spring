...
<div id="wrap">
	...
	//	alert()
		...
		wFrm.submit();
				...
				<form action="/board/reply" method="post", name="wFrm"
						...
						<table summary="분류, 제목, 상세내용, 첨부파일 순으로 궁금하신 점을 문의 하실수 있습니다." class="checkTable" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td>
										<select id="btop">
											<option value="3" <c:if test="${board.btop == 3 }"> selected </c:if>>답글</option>
										</select>
									</td>
								</tr>
								<tr>
									...
									<td>
										<input type="text" value="[답글] : ${board.btitle}" id="btitle" name="btitle" class="wlong" />
									</td>
								</tr>
								<tr>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>																
								...
								<li><a onclick="replyBtn()" class="sbtnMini">수정하기</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
