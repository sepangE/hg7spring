			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<li><input type="text" id="name" name="name" class="nameType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='nameType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							...
							<div class="btn"><a onclick="idSchBtn()" class="gbtn">아이디 찾기</a></div>
							<ul>
								<li><input type="text" id="pwcode" name="pwcode">
							</ul>
								<br>
								<button onclick="pwCodeCk()">인증번호 확인</button>
